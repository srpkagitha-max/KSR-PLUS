import { auth, db, onAuthStateChanged, collection, getDocs, $, esc } from './app.js?v=20260729-sprint10-telugu-parser-v1';
import { parseQuestionsDetailed } from './parser.js?v=20260729-sprint10-telugu-parser-v1';
